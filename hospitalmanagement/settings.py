"""
Django settings for Medical Administrative hub project.
...
ROOT_URLCONF = 'Medical Administrative hub.urls'
...
WSGI_APPLICATION = 'Medical Administrative hub.wsgi.application'
